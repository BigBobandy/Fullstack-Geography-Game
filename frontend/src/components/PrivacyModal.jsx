...
const Privacy = ({ setShowPrivacyModal }) => {
  return (
    <div className="modal-box fixed z-[1] left-0 top-0">
      <h3 className="font-bold text-lg">Privacy Policy</h3>
      <p>
        Jackson Dykes built the Geography Genius app as a Free app. This SERVICE
        is provided by Jackson Dykes at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        collected and stored by us for the purpose of creating and managing your
        account within our database.
      </p>
      <p>
      ...
      <p>
        ...
        <span className="underline font-medium">dirtyburgerdev@gmail.com</span>
      </p>{" "}
      <p>
